...
from (values
  ...
  ('PRODUK POC', 37, ARRAY['\bpoc\b']::text[], '\b(apa itu|itu apa|ini apa|apa sih|apaan|fungsi(nya)?|manfaat(nya)?|guna(nya)?|kegunaan(nya)?|kandungan(nya)?|deskripsi(nya)?|singkatan(nya)?|kepanjangan(nya)?|arti(nya)?|maksud(nya)?|jelasin|jelaskan|buat apa|untuk apa|produk apa)\b', ARRAY['\b(cara (pakai|penggunaan|pake|aplikasi)|gimana pakai|dosis|takaran|berapa ml|berapa gram|semprot|siram)\b', '\b(ready|stok|stock|kosong|harga|ongkir|kirim|resi|promo|diskon|garansi)\b']::text[], 'Deskripsi POC: pupuk organik cair untuk melebatkan buah & sayur. Kalimat tetap, tidak bergantung situasi pelanggan.'),
  ('PRODUK MIRACLE', 38, ARRAY['\bmiracle( ?powder)?\b']::text[], '\b(apa itu|itu apa|ini apa|apa sih|apaan|fungsi(nya)?|manfaat(nya)?|guna(nya)?|kegunaan(nya)?|kandungan(nya)?|deskripsi(nya)?|singkatan(nya)?|kepanjangan(nya)?|arti(nya)?|maksud(nya)?|jelasin|jelaskan|buat apa|untuk apa|produk apa)\b', ARRAY['\b(cara (pakai|penggunaan|pake|aplikasi)|gimana pakai|dosis|takaran|berapa ml|berapa gram|semprot|siram)\b', '\b(ready|stok|stock|kosong|harga|ongkir|kirim|resi|promo|diskon|garansi)\b']::text[], 'Deskripsi Miracle Powder: menggemburkan tanah yang mengeras. Kalimat tetap.'),
  ('PRODUK AKAR', 39, ARRAY['\b(produk|nutrisi|booster) akar\b']::text[], '\b(apa itu|itu apa|ini apa|apa sih|apaan|fungsi(nya)?|manfaat(nya)?|guna(nya)?|kegunaan(nya)?|kandungan(nya)?|deskripsi(nya)?|singkatan(nya)?|kepanjangan(nya)?|arti(nya)?|maksud(nya)?|jelasin|jelaskan|buat apa|untuk apa|produk apa)\b', ARRAY['\b(cara (pakai|penggunaan|pake|aplikasi)|gimana pakai|dosis|takaran|berapa ml|berapa gram|semprot|siram)\b', '\b(ready|stok|stock|kosong|harga|ongkir|kirim|resi|promo|diskon|garansi)\b']::text[], 'Deskripsi nutrisi akar: melebatkan akar & mengurangi stres tanaman stek. Kalimat tetap.'),
  ('PRODUK PELEBAT', 40, ARRAY['\b(paket )?pelebat\b']::text[], '\b(apa itu|itu apa|ini apa|apa sih|apaan|fungsi(nya)?|manfaat(nya)?|guna(nya)?|kegunaan(nya)?|kandungan(nya)?|deskripsi(nya)?|singkatan(nya)?|kepanjangan(nya)?|arti(nya)?|maksud(nya)?|jelasin|jelaskan|buat apa|untuk apa|produk apa)\b', ARRAY['\b(cara (pakai|penggunaan|pake|aplikasi)|gimana pakai|dosis|takaran|berapa ml|berapa gram|semprot|siram)\b', '\b(ready|stok|stock|kosong|harga|ongkir|kirim|resi|promo|diskon|garansi)\b']::text[], 'Deskripsi paket pelebat untuk tanaman berbuah. Kalimat tetap.'),
  ('PRODUK PESTISIDA', 41, ARRAY['\bpestisida\b']::text[], '\b(apa itu|itu apa|ini apa|apa sih|apaan|fungsi(nya)?|manfaat(nya)?|guna(nya)?|kegunaan(nya)?|kandungan(nya)?|deskripsi(nya)?|singkatan(nya)?|kepanjangan(nya)?|arti(nya)?|maksud(nya)?|jelasin|jelaskan|buat apa|untuk apa|produk apa)\b', ARRAY['\b(cara (pakai|penggunaan|pake|aplikasi)|gimana pakai|dosis|takaran|berapa ml|berapa gram|semprot|siram)\b', '\b(ready|stok|stock|kosong|harga|ongkir|kirim|resi|promo|diskon|garansi)\b']::text[], 'Deskripsi pestisida organik untuk ulat & kutu. Kalimat tetap; dosisnya tetap milik [PAKAI NEEM] atau AI.'),
  ('PRODUK SEEDBOOSTER', 42, ARRAY['\bseed ?booster\b']::text[], '\b(apa itu|itu apa|ini apa|apa sih|apaan|fungsi(nya)?|manfaat(nya)?|guna(nya)?|kegunaan(nya)?|kandungan(nya)?|deskripsi(nya)?|singkatan(nya)?|kepanjangan(nya)?|arti(nya)?|maksud(nya)?|jelasin|jelaskan|buat apa|untuk apa|produk apa)\b', ARRAY['\b(cara (pakai|penggunaan|pake|aplikasi)|gimana pakai|dosis|takaran|berapa ml|berapa gram|semprot|siram)\b', '\b(ready|stok|stock|kosong|harga|ongkir|kirim|resi|promo|diskon|garansi)\b']::text[], 'Deskripsi seed booster untuk mempercepat benih dorman bertunas. Kalimat tetap.'),
