# TECH STACK & PANDUAN DEVELOPER — AI Customer Service Infarm
> Versi: 1.0 | Dipisahkan dari `claude.md` pada 2 September 2026.
>
> **Berkas ini TIDAK PERNAH dikirim ke Claude API.** Isinya murni
> referensi untuk manusia & agen coding: arsitektur, roadmap, estimasi
> biaya, tema warna UI, dan standar responsivitas.
>
> Aturan perilaku AI (identitas, klasifikasi tindakan, gaya bahasa,
> format handover) ada di `claude-core.md` — itulah yang dimuat sebagai
> system prompt oleh `web/lib/knowledge.ts` dan `backend/knowledge.js`.
